...
function PreConf19() {
    ...
    return ( 
        ...
        <PcLinks year='2019' link1='https://link.springer.com/book/10.1007/978-981-15-1286-5'/>
        </div>
        <ImpDate/>
        </div>
