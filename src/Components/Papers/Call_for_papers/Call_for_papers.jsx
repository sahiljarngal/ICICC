...
const Call_for_papers = () => {
    ...
    return (
        <>
        <div>
            <h2 className="abtHeader">Call For Papers</h2>
         <hr />
                <div className="Call_con">
                    <div className="call_desc">
                        ...
                        <hr />
                            <b>ICICC 2023 will be an amalgamation of four different Tracks organized parallel to each other, as listed below:</b>
