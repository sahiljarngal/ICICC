...
const Call_for_Special = () => {
    ...
    return (
        ...
        <div className="Special_container">
            ...
            <br />
            <u>
                <span className='highlight'>Invitation to conduct special session in ICICC 2023</span>
            </u>
            <br />
            <br />
            ...
            <p>Greeting from ICICC-2023!
                ...
                <a href="">icicc-conf.com</a>.
                 ...
                 <br />
                 <span className='highlight'>Highlights of the conference and Special Session Benefits:</span> 
                 <br />
                 <ol>
                    ...
                    <li>Easy accessibility of the well-connected conference venue.</li></ol>
                    <br />
