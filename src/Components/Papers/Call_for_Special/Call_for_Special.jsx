            ...
            <p>Greeting from ICICC-2023!
                ...
                <a href="">icicc-conf.com</a>.
                 ...
                 <ol>
                    ...
                    <li> Extended papers in SCI/Scopus/ESCI/DBLP/ACM Digital Libr /ary journals. We have already got approval from some Scopus and high quality journals. (Soon will be declared)</li>
                    ...
                    <li>Easy accessibility of the well-connected conference venue.</li></ol><p>If you are interested to conduct a special session, kindly mail us the special session proposal at 
                        ...
                        <br />
                        <p className="greet">All the accepted papers (after double blinded peer review) will be published in a Springer series (Proposed) and further extended accepted papers will be published in the special issues of SCI/SCOPUS/WoS/DBLP/ACM/EI indexed Journals.</p>
                        <p>Looking to see you in ICICC-2023. 
                            <br />
                            <br />Sincerely,
                            <br />
