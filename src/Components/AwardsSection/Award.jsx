...
<div className="aParticipation">
    <div className="aPartcipationHead">
        <h1>CLICK HERE TO SEE THE REGISTRATION DETAILS FOR PARTICIPATION IN UILA 2022</h1>
    </div>
...
{/* Leadership awards  */}
      ...
      <div className="aImpDates">
        <h2>IMPORTANT DATES:</h2>
         ...
         <div className="aImpDatesMain">
            <p>Last date for nomination: <span>31st January, 2023</span></p>
            <p>Announcement of Result:  <span>28th February, 2023</span></p>
         </div>

         <div className="aImpInst">
            <h1>NO NOMINATION/AWARD FEES, BUT ALL THE AWARDEES SHOULD REGSITER FOR THE CONFERENCE TO PARTICIPATE IN THE AWARD CEREMONY</h1>
         </div>
      ...
      <div className="aAwardC">
        ...
        <hr />
        <h2>Leadership awards will honor the awards in the following categories:</h2>
      </div>
      ...
      <div className="aIndividual">
       ...
       <h3>Life time achievement Award</h3>
        <hr />
        <p>To honor outstanding leaders in education who have dedicated their life to the enhancement of the Institution/Organization and advancing the field of education with their pioneering spirit, demonstrated innovation, advocacy and career achievements that have improved the education industry. The Lifetime Achievement Award would be presented to an individual member whose long-term efforts, dedication, and sustained commitment has supported the organization/ Society/ Research/ Mankind.</p>
        </div>
      </div>
      ...
      <div className="aYoung">
        ...
        <hr />
        <p>To the research scholars, academicians and professionals from industries for their research work published in any International Journals or Conferences, having age not more than 35.</p>
      </div>
